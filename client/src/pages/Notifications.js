...
function Notifications() {
  ...
  const handleNotificationClick = (notification) => {
    if (notification.type === "new-doctor-request") {
      navigate(`/admin/doctor-application/${notification.data.doctorId}`);
    } else if (notification.type === "new-doctor-request-changed") {
      navigate(notification.onClickPath);
    } else if (notification.type === "new-appointment-request") {
      navigate(notification.onClickPath);
    }
  };
